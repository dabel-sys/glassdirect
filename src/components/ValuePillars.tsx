          ...
          {pillars.map((pillar, index) => {
            ...
            return (
              <motion.div
                key={index}
                style={{ y, opacity }}
                className="glass-panel rounded-3xl p-10 flex flex-col items-start hover:bg-black/[0.02] transition-colors duration-500"
              >
                <div className="w-16 h-16 rounded-2xl bg-black/5 flex items-center justify-center mb-8 border border-black/5">
